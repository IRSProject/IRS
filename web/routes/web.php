...
Route::group(['middleware' => ['auth']], function () {
  ...
  Route::get('/appointment/{id}/pass', 'AppointmentController@pass')->name('appointment.pass');
  Route::get('/appointment/{id}/fail', 'AppointmentController@fail')->name('appointment.fail');
